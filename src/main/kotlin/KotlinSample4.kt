...
import com.xfc_arch.codegen.domain.agents.kotlin.KotlinDataAgent
...
fun main() {
    dsl {
        ...
        gradle("KotlinSpringSample", langType = LangType.Kotlin) {
            ...
            agents {
                include(KotlinDataAgent())
                include(KotlinValueAgent())
                include(KotlinDtoAgent("DTO"))
