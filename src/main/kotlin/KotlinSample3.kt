...
import com.xfc_arch.codegen.domain.agents.kotlin.KotlinDtoAgent
...
fun main() {
    dsl {
        runConfig {
            modelPath = getAbsolutePath("codegen/samples/sample3/models")
            outPath = getAbsolutePath("codegen/samples/sample3/out")
        }
        ...
        gradle("KotlinSample", LangType.Kotlin) {
            basePackage("com.example.demo")

            agents {
                include(KotlinValueAgent())
                include(KotlinDtoAgent())
